...
- **Breaking**: remove the numeric plugin version and module selection; the host now matches the
  factory by ID and validates its execution mode and required contexts against the Rust registry.
